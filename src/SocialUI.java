...
public class SocialUI {
	...
	public SocialUI(JFrame menuFrame, Management mng) throws QueueEmpty, QueueFull 
	{
	...
	private void user(JFrame menuFrame, Management mng) throws QueueEmpty, QueueFull
	{
	...
	private void display(Management mng, JScrollPane scrollPane_1, JComboBox comboBox) throws QueueEmpty, QueueFull 
	{
