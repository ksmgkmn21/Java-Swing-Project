...
public class FileOperation {
    ...
    public void readSocial(HashMap<String, User> userMap) throws IOException, QueueFull {
        try {
    ...
    public void updateSocial(HashMap<String, User> userMap) throws IOException, QueueEmpty, QueueFull {
